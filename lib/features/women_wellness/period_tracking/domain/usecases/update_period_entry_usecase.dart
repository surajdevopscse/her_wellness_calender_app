...
/// Updates a period entry after validation.
class UpdatePeriodEntryUseCase {
  const UpdatePeriodEntryUseCase(this.repository);
  ...
  Future<PeriodEntry> call(PeriodEntry entry) {
    ...
    return repository.updatePeriodEntry(entry);
  }
}
